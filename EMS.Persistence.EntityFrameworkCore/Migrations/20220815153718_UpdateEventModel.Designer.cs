...
namespace EMS.Persistence.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20220815153718_UpdateEventModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EMS.Core.Application.Domain.Events.Event", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateUtc = new DateTime(2022, 8, 15, 15, 37, 17, 425, DateTimeKind.Utc).AddTicks(3288),
                            Description = "Hello world",
                            EndDate = new DateTime(2022, 6, 8, 17, 0, 0, 0, DateTimeKind.Unspecified),
                            Location = "Barbados",
                            ModifiedDateUtc = new DateTime(2022, 8, 15, 15, 37, 17, 425, DateTimeKind.Utc).AddTicks(3294),
                        ...
                        new
                        {
                            Id = 2L,
                            CreatedById = new Guid("2d42b6a9-591b-4178-a4ab-431b3f337fd0"),
                            CreatedDateUtc = new DateTime(2022, 8, 15, 15, 37, 17, 425, DateTimeKind.Utc).AddTicks(5604),
                            Description = "lorum epsum",
                            EndDate = new DateTime(2022, 8, 10, 17, 0, 0, 0, DateTimeKind.Unspecified),
                            Location = "Antigua",
                            ModifiedDateUtc = new DateTime(2022, 8, 15, 15, 37, 17, 425, DateTimeKind.Utc).AddTicks(5607),
            ...
            modelBuilder.Entity("EventVolunteer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            EventsId = 1L,
                            VolunteersId = "1BE12301-3337-4223-819D-9D36296AC6B9"
                        },
                        new
                        {
                            EventsId = 1L,
                            VolunteersId = "7DE1CD22-A7A7-4335-9060-24CECA03DE4F"
                        },
                        new
                        {
                            EventsId = 2L,
                            VolunteersId = "71785F0B-D204-49C5-A5E8-12151829557F"
                        },
                        new
                        {
                            EventsId = 2L,
                            VolunteersId = "F312FB13-12EF-4F93-8F16-A9C9A0CEA4C1"
                        });
                });
            ...
            modelBuilder.Entity("EMS.Core.Application.Domain.Users.Volunteer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Status = 1,
                            UpdatedById = new Guid("84ada39a-2521-4e26-94f6-98d7e7a9bdd2"),
                            DateOfBirth = new DateTime(2022, 8, 15, 15, 37, 17, 424, DateTimeKind.Utc).AddTicks(3155),
                            Height = 1.0,
                            Weight = 1.0
                        },
                        new
                        {
                            ...
                            Status = 1,
                            UpdatedById = new Guid("84ada39a-2521-4e26-94f6-98d7e7a9bdd2"),
                            DateOfBirth = new DateTime(2022, 8, 15, 15, 37, 17, 424, DateTimeKind.Utc).AddTicks(4362),
                            Height = 1.0,
                            Weight = 1.0
                        },
                        new
                        {
                            ...
                            Status = 1,
                            UpdatedById = new Guid("84ada39a-2521-4e26-94f6-98d7e7a9bdd2"),
                            DateOfBirth = new DateTime(2022, 8, 15, 15, 37, 17, 424, DateTimeKind.Utc).AddTicks(4392),
                            Height = 1.0,
                            Weight = 1.0
                        },
                        new
                        {
                            ...
                            Status = 1,
                            UpdatedById = new Guid("84ada39a-2521-4e26-94f6-98d7e7a9bdd2"),
                            DateOfBirth = new DateTime(2022, 8, 15, 15, 37, 17, 424, DateTimeKind.Utc).AddTicks(4404),
                            Height = 1.0,
                            Weight = 1.0
                        });
                });
            ...
            modelBuilder.Entity("EventVolunteer", b =>
                {
                    b.HasOne("EMS.Core.Application.Domain.Events.Event", null)
                        .WithMany()
