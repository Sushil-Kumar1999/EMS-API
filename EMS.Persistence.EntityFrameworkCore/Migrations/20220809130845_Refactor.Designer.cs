...
namespace EMS.Persistence.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20220809130845_Refactor")]
            ...
            modelBuilder.Entity("EMS.Core.Application.Domain.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateUtc = new DateTime(2022, 8, 9, 13, 8, 44, 197, DateTimeKind.Utc).AddTicks(6736),
                        ...
                        new
                        {
                            Id = 2L,
                            CreatedById = new Guid("2d42b6a9-591b-4178-a4ab-431b3f337fd0"),
                            CreatedDateUtc = new DateTime(2022, 8, 9, 13, 8, 44, 197, DateTimeKind.Utc).AddTicks(8846),
            ...
            modelBuilder.Entity("EMS.Core.Application.Domain.Users.Volunteer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Status = 1,
                            UpdatedById = new Guid("84ada39a-2521-4e26-94f6-98d7e7a9bdd2"),
                            DateOfBirth = new DateTime(2022, 8, 9, 13, 8, 44, 196, DateTimeKind.Utc).AddTicks(1575),
                            Height = 1.0,
                            Weight = 1.0
                        },
                        new
                        {
                            ...
                            Status = 1,
                            UpdatedById = new Guid("84ada39a-2521-4e26-94f6-98d7e7a9bdd2"),
                            DateOfBirth = new DateTime(2022, 8, 9, 13, 8, 44, 196, DateTimeKind.Utc).AddTicks(2988),
                            Height = 1.0,
                            Weight = 1.0
                        },
                        new
                        {
                            ...
                            Status = 1,
                            UpdatedById = new Guid("84ada39a-2521-4e26-94f6-98d7e7a9bdd2"),
                            DateOfBirth = new DateTime(2022, 8, 9, 13, 8, 44, 196, DateTimeKind.Utc).AddTicks(3185),
                            Height = 1.0,
                            Weight = 1.0
                        },
                        new
                        {
                            ...
                            Status = 1,
                            UpdatedById = new Guid("84ada39a-2521-4e26-94f6-98d7e7a9bdd2"),
                            DateOfBirth = new DateTime(2022, 8, 9, 13, 8, 44, 196, DateTimeKind.Utc).AddTicks(3198),
                            Height = 1.0,
                            Weight = 1.0
                        });
                });
