...
namespace EMS.Persistence.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20220809131938_SeedEventVolunteerTable")]
    partial class SeedEventVolunteerTable
    {
            ...
            modelBuilder.Entity("EMS.Core.Application.Domain.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateUtc = new DateTime(2022, 8, 9, 13, 19, 37, 732, DateTimeKind.Utc).AddTicks(8886),
                        ...
                        new
                        {
                            Id = 2L,
                            CreatedById = new Guid("2d42b6a9-591b-4178-a4ab-431b3f337fd0"),
                            CreatedDateUtc = new DateTime(2022, 8, 9, 13, 19, 37, 733, DateTimeKind.Utc).AddTicks(1531),
            ...
            modelBuilder.Entity("EMS.Core.Application.Domain.Users.Volunteer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Status = 1,
                            UpdatedById = new Guid("84ada39a-2521-4e26-94f6-98d7e7a9bdd2"),
                            DateOfBirth = new DateTime(2022, 8, 9, 13, 19, 37, 731, DateTimeKind.Utc).AddTicks(2308),
                            Height = 1.0,
                            Weight = 1.0
                        },
                        new
                        {
                            ...
                            Status = 1,
                            UpdatedById = new Guid("84ada39a-2521-4e26-94f6-98d7e7a9bdd2"),
                            DateOfBirth = new DateTime(2022, 8, 9, 13, 19, 37, 731, DateTimeKind.Utc).AddTicks(4233),
                            Height = 1.0,
                            Weight = 1.0
                        },
                        new
                        {
                            ...
                            Status = 1,
                            UpdatedById = new Guid("84ada39a-2521-4e26-94f6-98d7e7a9bdd2"),
                            DateOfBirth = new DateTime(2022, 8, 9, 13, 19, 37, 731, DateTimeKind.Utc).AddTicks(4273),
                            Height = 1.0,
                            Weight = 1.0
                        },
                        new
                        {
                            ...
                            Status = 1,
                            UpdatedById = new Guid("84ada39a-2521-4e26-94f6-98d7e7a9bdd2"),
                            DateOfBirth = new DateTime(2022, 8, 9, 13, 19, 37, 731, DateTimeKind.Utc).AddTicks(4309),
                            Height = 1.0,
                            Weight = 1.0
                        });
                });
